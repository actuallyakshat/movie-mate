...
const Testimonial = (props) => {
  ...
  return (
    <div className="mt-32 mb-16 w-[85vw] md:w-[700px] mx-auto bg-platinumSilver flex flex-col items-center justify-center p-10 transition-all duration-700 rounded-md shadow-md hover:shadow-xl">
      <Card review={reviews[index]} />
      <div className="flex text-lg mt-9 gap-6 text-darkGreen mx-auto">
        <button onClick={leftShiftHandler} className="cursor-pointer font-thin">
          <FaChevronLeft />
        </button>
