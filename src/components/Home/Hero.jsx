...
const Hero = () => {
  return (
    <div className="h-full bg-hero-curves bg-no-repeat bg-cover pt-10" id="hero">
      <div className="w-[65%] h-screen text-platinumSilver pt-[6rem] md:pt-[5em] mx-auto text-cener flex justify-between ">
        <div className="w-full mx-auto md:m-0 md:text-left text-center">
          <h1 className="text-4xl md:text-6xl font-bold py-2">Movie Mate</h1>
        ...
        <div className="w-[24vw] h-fit overflow-hidden mt-[-3rem] hidden md:block mr-12">
          <img
